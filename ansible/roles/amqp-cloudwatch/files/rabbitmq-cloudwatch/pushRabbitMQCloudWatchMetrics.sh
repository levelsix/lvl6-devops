...
/usr/local/bin/aws cloudwatch put-metric-data --metric-name $1 --namespace "$3" --value $2 --timestamp $timestamp --dimensions "instanceId=$EC2_INSTANCE_ID,ec2_hostname=$EC2_HOSTNAME,az=$AZ,hostname=$HOSTNAME"
